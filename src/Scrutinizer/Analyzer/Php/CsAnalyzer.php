...
class CsAnalyzer extends AbstractFileAnalyzer
{
    ...
    public function buildConfigInternal(ConfigBuilder $builder)
    {
        ...
        $sniffNodeDefinition = $builder->perFileConfig()->children()->arrayNode('sniffs');
        $sniffNodeDefinition
            ->addDefaultsIfNotSet()
            ->attribute('depends_on', array('standard' => 'custom'))
        ;

        $this->addPsr1Sniffs($sniffNodeDefinition);
        $this->addGenericSniffs($sniffNodeDefinition);
        $this->addZendSniffs($sniffNodeDefinition);
        $this->addSquizSniffs($sniffNodeDefinition);
        $this->addMySourceSniffs($sniffNodeDefinition);
        $this->addPsr2Sniffs($sniffNodeDefinition);
        $this->addPearSniffs($sniffNodeDefinition);
        $this->addWordpressSniffs($sniffNodeDefinition);
    }

    private function addPsr1Sniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('psr1')
    ...
    private function addGenericSniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('generic')
    ...
    private function addZendSniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('zend')
    ...
    private function addSquizSniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('squiz')
    ...
    private function addMySourceSniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('my_source')
    ...
    private function addPsr2Sniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('psr2')
    ...
    private function addPearSniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('pear')
    ...
    private function addWordpressSniffs(ArrayNodeDefinition $sniffNodeDefinition)
    {
        $sniffNodeDefinition
            ->children()
                ->arrayNode('wordpress')
